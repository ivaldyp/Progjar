...
class Elemental(ConnectionListener):
    ...
    def initGraph(self):
        self.daun = pygame.image.load("Image/daun.png").convert_alpha()
        self.air = pygame.image.load("Image/air.jpg").convert_alpha()
        self.api = pygame.image.load("Image/api.jpg").convert_alpha()
        self.panel = pygame.image.load("Image/score_panel.png").convert_alpha()
        self.red = pygame.image.load("Image/redindicator.png").convert_alpha()
        self.green = pygame.image.load("Image/greenindicator.png").convert_alpha()
